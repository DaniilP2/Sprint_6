...
@allure.feature('Логотипы на главной странице')
class TestHeader:
    ...
    def test_success_click_scooter_logo_open_main_page(self, driver):
    ...
    def test_success_click_yandex_logo_open_dzen_page(self, driver):
        page = HeaderPage(driver)
        page.open_main_page()
