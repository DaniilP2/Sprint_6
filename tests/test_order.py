...
class TestOrder:
    ...
    def test_success_order_entry_click_header_button(self, driver):
    ...
    def test_success_order_entry_click_roadmap_button(self, driver):
        page = OrderPage(driver)
        page.open_main_page()
    ...
    def test_success_order(self, driver, fields):
        page = OrderPage(driver)
    ...
    def test_success_show_success_modal_order(self, driver):
        page = OrderPage(driver)
        page.open_order_page()
